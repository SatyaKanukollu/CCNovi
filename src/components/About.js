      ...
      <div class="container">
        ...
        <div class="about-content">
          <div class="about-text">
            <p>Founded with a passion for automotive excellence, Classic Collision has been Novi's premier destination for collision repair and restoration for over 15 years. Our commitment to quality and customer satisfaction has made us the trusted choice for vehicle repairs in the community.</p>
            <p>Our team of certified technicians brings decades of combined experience to every project, ensuring your vehicle receives the highest standard of care and craftsmanship.</p>
          </div>
        </div>
